...
export default function NotFound() {
  return (
    <>
      <Head>
        <title> Amaury Vasquez | Page not found </title>
        <meta
          name="description"
        ...
        <div className="hero-content max-w-screen px-4 text-center">
          <article className="max-w-screen xs:max-w-md md:max-w-3xl lg:max-w-4xl flex flex-col gap-8">
            ...
            <p>
              ...
              doesn&apos;t exists on this site. Check the links below to find
              what you&apos;re looking for and getting inmersed in my portfolio.
            </p>
