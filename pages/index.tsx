  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://amauryvasquez.com/" />
      </Head>
        ...
        <div className="hero-content max-w-screen px-4 text-center">
          <article className="max-w-screen xs:max-w-md md:max-w-3xl lg:max-w-4xl flex flex-col gap-8">
            ...
            <p>
              ...
              my portfolio. I am a web developer with technical prowess and a
              keen eye for aesthetics. With a focus on user-centric design and a
              deep understanding of the latest web development technologies, I
              bring websites and applications to life.
            </p>
