    ...
    <div className="max-w-screen xs:max-w-md sm:max-w-xl md:max-w-3xl lg:max-w-6xl grid-cols-1 grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-4">
      <article className="flex flex-col gap-4 items-center w-full rounded-md p-4 h-full justify-center">
        ...
        <p className="flex w-full gap-1 items-center">
          <strong className="font-medium text-primary">Country: </strong> Mexico
        ...
        <p className="flex w-full gap-1 flex-wrap">
          <strong className="font-medium text-primary">Hobbies: </strong> Soccer
          ⚽ Chess ♟️ Gaming 🎮
        </p>
      </article>
      <article className="flex flex-col gap-4 items-center w-full rounded-md h-full p-4 lg:col-span-2">
        ...
        <h3 className="text-xl font-medium w-full text-primary">Tech stack</h3>
      ...
      <article className="flex flex-col gap-4 items-center w-full rounded-md h-full p-4 md:col-span-2 lg:col-span-3">
        ...
        <p>
          My mindset is rooted in the Japanese principles of ikigai and kaizen.
          Ikigai guides me to find purpose and meaning in life by aligning my
          passions, values, skills, and world needs. It encourages me to pursue
          activities that bring joy, fulfillment, and a sense of contribution.
          Kaizen, on the other hand, is a philosophy of continuous improvement.
          It inspires me to make small, incremental changes in my life to
          achieve long-term growth and excellence.
        </p>
      </article>
    </div>
  </main>
